...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/fs/pathparser.o ./build/string/string.o ./build/disk/diskstreamer.o ./build/fs/file.o
INCLUDES = -I./src
...
all: ./bin/boot.bin ./bin/kernel.bin
	...
	sudo mount -t vfat ./bin/os.bin /media/alexandre/eruos
	sudo cp ./data/hello.txt /media/alexandre/eruos
	sudo umount /media/alexandre/eruos
...
./build/fs/pathparser.o: ./src/fs/pathparser.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/fs/pathparser.c -o ./build/fs/pathparser.o
...
./build/disk/diskstreamer.o: ./src/disk/diskstreamer.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/disk/diskstreamer.c -o ./build/disk/diskstreamer.o
